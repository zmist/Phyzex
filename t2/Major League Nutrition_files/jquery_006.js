...
function set_main_img(){
				$orig.find('img').each(function(){
					...
					cont += '<li><img src="../../samp2/Major League Nutrition_files/' + $this.attr('src') + '" /></li>'; 
				});
